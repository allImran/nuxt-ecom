  ...
  <div class="space-y-4">
    ...
    >
      ...
      <div v-else class="flex flex-col items-center gap-2">
        <UiIcon name="image" :size="40" class="text-luxury-text-muted dark:text-luxury-dark-text-muted" />
    ...
    <div v-if="images.length > 0" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
      ...
      >
        ...
        <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center gap-2">
          ...
          >
            <UiIcon name="chevron-left" :size="16" class="text-white" />
          </button>
          ...
          <button
            ...
            @click.stop="moveImage(index, index + 1)"
          >
            <UiIcon name="chevron-right" :size="16" class="text-white" />
          </button>
          ...
          >
            <UiIcon name="x" :size="16" class="text-white" />
          </button>
        </div>
