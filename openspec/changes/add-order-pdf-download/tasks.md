...
- [x] 1.3 Verify UrbanEase logo exists at `/public/urban-ease-logo.png`
...
- [x] 3.5 Implement PDF header:
  - [x] 3.5.1 Add UrbanEase logo to top-left (40-50mm width)
...
- UrbanEase logo must be available at `/public/urban-ease-logo.png` before implementation
